(function() {
  ...
  L.GeoJSON.Pouch = L.GeoJSON.extend({
    ...
    initialize: function(remoteDB, opts) {
      ...
      return PouchDB(this._dbName, function(e1, db1) {
        if (!e1) {
          _this.localDB = db1;
          ...
          if (remoteDB) {
            ...
            _this.sync = function(cb) {
              ...
              switch (this.pouchParams.direction) {
                case "from":
                  this._from = PouchDB.replicate(this.localDB, this.remoteDB, options);
                  break;
                case "to":
                  this._to = PouchDB.replicate(this.remoteDB, this.localDB, options);
                  break;
                case "both":
                  this._from = PouchDB.replicate(this.localDB, this.remoteDB, options);
                  this._to = PouchDB.replicate(this.remoteDB, this.localDB, options);
    ...
    destroy: function(cb) {
      ...
      return PouchDB.destroy(this._dbName, cb);
    }
  });
